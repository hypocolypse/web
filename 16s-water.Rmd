...
Time to group some of the taxa into an *Other* catagory for the bar graph. Since we cannot possibly display all `r nrow(means_w)` differnt taxa in one figure, we need to collapse some.  
...
Time to group some of the taxa into an *Other* catagory for the bar graph. Since we cannot possibly display all `r nrow(means_tm)` differnt taxa in one figure, we need to collapse some.  
