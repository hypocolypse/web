...
#### 1. Generate the ASV & reads table
...
datatable(
  ...
  options = list(
    ...
    pageLength = 5,
    scroller=TRUE, lengthMenu = c(10, 25, 51)))
...
target <- c("Oxyphotobacteria", "Alphaproteobacteria", 
            "Bacteroidia", "Gammaproteobacteria", 
            "Thermoplasmata", "Deltaproteobacteria", 
...
datatable(
  ...
  options = list(columnDefs = list(list(
    ...
    scrollX = TRUE, scrollCollapse = TRUE, scrollY=TRUE,
    pageLength = 9,
    scroller=TRUE, lengthMenu = c(9, 25, 51)))
```
...
target <- c("Oxyphotobacteria", "Alphaproteobacteria", 
            "Bacteroidia", "Gammaproteobacteria", 
            "Thermoplasmata", "Deltaproteobacteria", 
            "Acidimicrobiia", "Phylum_Marinimicrobia_(SAR406_clade)", "Other")
