...
Output files from this workflow available on figshare at [XXX](YYY). The *16s-water.rdata* file contains all variables and phyloseq objects from this pipeline and is needed for the next workflow (as are the .rds files). 
