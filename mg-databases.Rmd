...
I generally followed [this recipe](https://github.com/simroux/VirSorter) for installing VirSorter except I separated out the installation of dependencies to individual commands because I like to monitor any conflicts between packages.
...
The source code for this page can be accessed on GitHub by [clicking this link](https://github.com/hypocolypse/web/blob/master/mg-databases.Rmd).
