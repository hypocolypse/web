...
Data & Code Availability: DOI and accession numbers for study related data.    
Supplementary Table 1: Primer sequences for 16S rRNA gene amplification.    
...
**Supplementary Fig. 2. Photophysiology of *Agaricia* during the acute deoxygenation event.** Box plots with colony means overlaid for *Agaricia* tenuifolia **a**) maximum quantum yield (i.e., photosynthetic efficiency) **b**) and chlorophyll a concentration. Coral fragments were collected from the impacted (**vermillion**) and reference (**blue**) sites during the deoxygenation event, with three fragments from each of six colonies per site. The center line indicates the median, the box limits the interquartile range, and the whiskers the minimum and maximum for the data. Lower quantum yield and chlorophyll concentrations are indicative of coral bleaching (**red arrow**).
